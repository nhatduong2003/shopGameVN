...
<head>
    <meta charset="utf-8" />
    <title>Web Bán Nick, Có Đủ Mọi Loại Game Hót Thịnh Hành Tại ShopGameFF</title>
            ...
            <div class="container">
                ...
                <nav class="c-top-menu c-pull-right m-t-10">
                    <ul class="c-links c-theme-ul">
                        <li>
                            Hotline: <a href="tel:0347.xxx.100">0347.xxx.100 </a>
                        </li>
                ...
                <div id="slide_banner" class="owl-carousel">
                    ...
                    <div class="item">
                        <a href="#" alt="{{$sli->title}}">
                            <img src="{{asset('uploads/slider/'.$sli->image)}}" alt="" height="350px" width="100%">
                        </a>
                    </div>
                    <!-- <div class="item">
                        <a href="/" alt="nitvn2">
                        ...
                        <div class="c-container c-first">
                           ...
                           <li><a href="/lien-he-gop-y"> Liên hệ/góp ý</a></li>
                            ...
                            <ul>
                                ...
                                <li><strong><span style="font-size:14px"><a href="/tuyen-dai-ly-cung-cap-nick-tai-nickvn" target="_blank"><span style="color:#ffffff">Tuyển Đại L&yacute; cung cấp nick tại ShopGameFF.VN</span></a></span></strong></li>
                    ...
                    <div class="col-md-4">
                        <div class="c-container c-last">
                           ...
                           <li><i class="icon-clock c-theme-font"></i><span class="c-font-regular">8h-11h30 & 13h30-22h</span></li>
                            ...
                            <p>&nbsp;</p>
                            <p><span style="color:#ffffff">&nbsp;<strong>Hotline:</strong>&nbsp;<strong>0347.xxx.100</strong></span></p>
                            <p><span style="color:#ffffff">&nbsp;<strong>Thời gian l&agrave;m việc&nbsp;8h-11h30 &amp; 13h30-23h</strong></span></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div id="fb-root"></div>
